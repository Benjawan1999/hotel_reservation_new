        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="navbar-brand" href="Manu/Booked/listroom.php">Booking</a>
                    </li>
                    <li class="nav-item">
                        <a href="Manu/User/mybooking.php" class="navbar-brand">My Booking</a>
                    </li>
                    <li class="nav-item">
                        <a href="Manu/User/editaccount.php" class="navbar-brand">Edit Account</a>
                    </li>
