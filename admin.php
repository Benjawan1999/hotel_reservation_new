    ...
    <nav class="navbar navbar-dark bg-dark navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="Manu/Room/room.php" class="navbar-brand">Room</a>
                    </li>
                    <li class="nav-item">
                        <a class="navbar-brand" href="Manu/RoomType/roomtype.php">RoomType</a>
                    </li>
                    <li class="nav-item">
                        <a href="Manu/Package/package.php" class="navbar-brand">Package</a>
                    </li>
                    <li class="nav-item">
                        <a href="Manu/News/news.php" class="navbar-brand">News</a>
                    </li>
                    <li class="nav-item">
                        <a href="Manu/check.php" class="navbar-brand">Check Booking</a>
                    </li>
                    <li class="nav-item">
                        <a href="Manu/Report.php" class="navbar-brand">Report</a>
                    </li>
                    <li class="nav-item">
                        <a href="Manu/Member/member.php" class="navbar-brand">Member</a>
                    </li>
                    <li class="nav-item">
                        <a href="Manu/checkoutbooking.php" class="navbar-brand">Check Out</a>
                    </li>
                </ul>

                <div class="d-flex">
                    <a class="navbar-brand ">Welcome Admin, <?php echo $row['firstname'] . ' ' . $row['lastname'] ?></a>
